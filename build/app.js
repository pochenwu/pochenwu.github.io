...
_vue2.default.component('profile-card', {
...
_vue2.default.component('profile', {
...
window.addEventListener('load', function () {
  ...
  var profilePicTM = new _hammerjs2.default.Manager(profilePic, { recognizers: [
    // RecognizerClass, [options], [recognizeWith, ...], [requireFailure, ...]
    [_hammerjs2.default.Tap], [_hammerjs2.default.Swipe], [_hammerjs2.default.Pan, { threshold: 1.5 }]]
  });
  ...
  profilePicTM.on("panend", function (e) {
    if (!isCardOpen) {
      ...
      var swipeOutAnime = (0, _animejs2.default)({
        targets: currentCard,
      ...
      var resetPositionAnime = (0, _animejs2.default)({
        targets: currentCard,
